class UserTablesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_table.save
        ...
        format.json { render :show, status: :created, location: @user_table }
      else
  ...
  def update
    respond_to do |format|
      if @user_table.update(user_table_params)
        ...
        format.json { render :show, status: :ok, location: @user_table }
      else
  ...
  private
    ...
    def user_table_params
      params.require(:user_table).permit(:user_name, :user_pass, :user_mail)
    end
end
